...
description: "How to build custom symbols and footprints in KiCad."
pubDate: 2024-07-29
author: "Orion Serup"
...
Name the symbol the name of the component you want to add. The reference designator must be added to indicate the type of component. These follow [IEEE 315](https://standards.ieee.org/ieee/315/3628/) / ASME Y14.44 conventions:
...
2. **Follow standards**: IPC for footprints, IEEE 315 for reference designators
